...
- Допустимое отклонение: ±10 слов от требуемой длины (например, для 150 слов подходит 140–160).
- Если длина попадает в диапазон — считай, что всё ок, и выводи текст как свой ответ (обычное текстовое сообщение), не вызывай больше инструментов.
- Если длина не попадает в диапазон — скорректируй текст и проверь снова.
